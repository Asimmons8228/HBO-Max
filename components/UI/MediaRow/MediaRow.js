...
const MediaRow = (props) =>{
    ...
    useEffect (() => {
        axios.get('https://api.themoviedb.org/3/discover/movie?with_genres=28&primary_release_year=2023&api_key=6d1dcfd285874d37cf4305319bf0609e&language=en')
    ...
    const showThumbnails = () => {
        return loadingData ? loopComp((<Skeleton />), 10) : movies.map((movie) => {
